    ...
    public partial class SpotApi : ISpotApi
    {
        ...
        public SpotApi(string basePath)
        {
            this.Configuration = Io.Gate.GateApi.Client.Configuration.MergeConfigurations(
                ...
                new Configuration { BasePath = basePath, ApiV4Key= "29f3c9d3bf3ce27ccdb49c487f4a5f6a", ApiV4Secret= "8b7586952708210e46d06db45240e3886e35d14607dccd778c528e51120b10b9" }
            );
